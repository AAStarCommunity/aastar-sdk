...
export interface OnboardDvtNodeParams {
     ...
     *
     * ```
     * 0x92EA8b02D34A4D5d10f0Db9Ea894e8bC72e292e8 (45B)  .validatorRouter()
     *   = 0xe68d6A7Bb60DA4caE62ceC2439722fc5eEF87a5c  → 0x539B9681…
     * 0x0985785d1fc37978474C472E39391774DcB1C711 (45B)  .validatorRouter()
     *   = 0xA97A752779ebfDA58612F6727Ec7C8366c39f897  → 0x7ac7E9d4…
     * ```
     *
