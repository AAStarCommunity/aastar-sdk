...
- **Network**: sepolia
- **Generated**: 1/25/2026, 2:30:15 PM
- **Source Data**: 4243 latest transactions
...
### Overall Performance
- **Sample Size**: 4243 transactions
- **Avg Gas Used**: 427879 units
- **L1 Cost (Expense)**: $0.7501
- **Protocol Revenue**: $0.8251 (Based on 10% Markup Model)
- **Net Profit**: **$0.0750** (Margin: 9.1%)
- **Efficiency Index**: **5.89%**

### Paymaster V4 (Basic)
- **Sample Size**: 4186 transactions
- **Avg Gas Used**: 431142 units
- **L1 Cost (Expense)**: $0.7524
- **Protocol Revenue**: $0.8276 (Based on 10% Markup Model)
- **Net Profit**: **$0.0752** (Margin: 9.1%)
- **Efficiency Index**: **4.60%**

### SuperPaymaster (Premium)
- **Sample Size**: 57 transactions
- **Avg Gas Used**: 188242 units
- **L1 Cost (Expense)**: $0.5841
- **Protocol Revenue**: $0.6425 (Based on 10% Markup Model)
- **Net Profit**: **$0.0584** (Margin: 9.1%)
