...
- **Network**: op-sepolia
- **Generated**: 1/25/2026, 6:23:08 PM
- **Source Data**: 687 latest transactions
...
- **Avg Gas Used**: 148476 units
- **L1 Cost (Expense)**: $0.0000
- **Protocol Revenue**: $0.0000 (Based on 10% Markup Model)
- **Net Profit**: **$0.0000** (Margin: 9.1%)
- **Efficiency Index**: **76.00%**

### Paymaster V4 (Basic)
- **Sample Size**: 46 transactions
- **Avg Gas Used**: 145907 units
- **L1 Cost (Expense)**: $0.0000
- **Protocol Revenue**: $0.0000 (Based on 10% Markup Model)
- **Net Profit**: **$0.0000** (Margin: 9.1%)
- **Efficiency Index**: **73.91%**

### SuperPaymaster (Premium)
- **Sample Size**: 4 transactions
- **Avg Gas Used**: 178018 units
