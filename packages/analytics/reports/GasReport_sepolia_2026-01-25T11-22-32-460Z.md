...
- **Network**: sepolia
- **Generated**: 1/25/2026, 6:22:32 PM
...
- **Avg Gas Used**: 163660 units
- **L1 Cost (Expense)**: $0.4162
- **Protocol Revenue**: $0.4578 (Based on 10% Markup Model)
- **Net Profit**: **$0.0416** (Margin: 9.1%)
- **Efficiency Index**: **74.44%**
