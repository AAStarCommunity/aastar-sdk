...
[dotenv@17.2.3] injecting env (28) from .env.sepolia -- tip: 🔐 prevent building .env in docker: https://dotenvx.com/prebuild
...
- **平均 EVM Gas 消耗**: 166378 units
- **原生 UserOp 消耗 (aPNTs)**: 0 units
- **协议开销 (Overhead)**: 166378 units
- **效率指数 (Efficiency)**: **8049276.35%** (100% 为原生消耗无开销)

### Layer 2: Economic (市场/经济成本层)
- **L1 实际平均支出**: $0.5973 (ETH @ $3211.75)
- **协议平均补贴额**: **$0.3525**
- **综合效率得分**: **80/100**
...
- **预计总成本**: $0.0549
- **预计节省倍数**: **9.9x**
- **成本结构**: L2 Execution ($0.0005) + L1 Data ($0.0544)

## 4. 成本结构归因 (USD context)
...
1. **学术观察**: 协议的 intrinsic overhead 约为 **-8049176.4%**，这主要来源于 postOp 的逻辑复杂度。
2. **补贴现状**: 协议当前承担了 **59.0%** 的总运行成本，以维持 Gasless 用户体验。
3. **优化方向**: 迁移至 L2 后，即便 overhead 不变，总成本预计可降低达 **89.91201228287414%**。
