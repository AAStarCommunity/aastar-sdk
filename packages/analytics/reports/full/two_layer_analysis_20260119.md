...
- **原生 UserOp 消耗 (aPNTs)**: 17 units
- **协议开销 (Overhead)**: 166361 units
- **效率指数 (Efficiency)**: **8879575579333967.00%** (100% 为原生消耗无开销)
...
1. **学术观察**: 协议的 intrinsic overhead 约为 **-8879575579333867.0%**，这主要来源于 postOp 的逻辑复杂度。
