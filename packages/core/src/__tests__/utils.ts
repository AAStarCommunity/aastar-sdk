...
export const TEST_ADDRESSES = {
    ...
    factory: '0x6000000000000000000000000000000000000006' as Address,
    registry: '0x7000000000000000000000000000000000000007' as Address,
    entryPoint: '0x8000000000000000000000000000000000000008' as Address,
    oracle: '0x9000000000000000000000000000000000000009' as Address,
};
