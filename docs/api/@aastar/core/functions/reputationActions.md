> **reputationActions**(`address`): (`client`) => [`ReputationActions`](../type-aliases/ReputationActions.md)

Defined in: [packages/core/src/actions/reputation.ts:67](https://github.com/AAStarCommunity/aastar-sdk/blob/f3911a6f6e88b2f77186db63ad0182c2cfe13b9d/packages/core/src/actions/reputation.ts#L67)
...
> (`client`): [`ReputationActions`](../type-aliases/ReputationActions.md)
