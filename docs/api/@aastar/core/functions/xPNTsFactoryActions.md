> **xPNTsFactoryActions**(`address`): (`client`) => [`XPNTsFactoryActions`](../type-aliases/XPNTsFactoryActions.md)

Defined in: [packages/core/src/actions/factory.ts:121](https://github.com/AAStarCommunity/aastar-sdk/blob/ee2dd989851034f323f1aad02b8ecb5fe586602a/packages/core/src/actions/factory.ts#L121)
...
> (`client`): [`XPNTsFactoryActions`](../type-aliases/XPNTsFactoryActions.md)
