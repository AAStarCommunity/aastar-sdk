...
Defined in: [packages/core/src/actions/account.ts:32](https://github.com/AAStarCommunity/aastar-sdk/blob/ee2dd989851034f323f1aad02b8ecb5fe586602a/packages/core/src/actions/account.ts#L32)
...
> (`client`): [`AccountActions`](../type-aliases/AccountActions.md)
